...
"""
# Wersja bez użycia funkcji rekurencyjnej
...
n - 1 disks from the source to the auxiliary rod the largest disk from the source to the target
...
But if you try to do so without defining a base case, you will get a RecursionError. This happens because the function keeps calling itself indefinitely."""
