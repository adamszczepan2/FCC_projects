...
and you'll use them together with what you already learned to create a program that calculates a projectile trajectory."""
...
def projectile_helper(speed, height, angle):
    ...
    print(f"{str(ball)}")
    print(f"{graph.create_coordinates_table()}")
    print(f"{graph.create_trajectory()}")
